...
/// Revision
pub const REVISION: &str = "SDL-3.4.2-fix-keyup";

/// Version part of the revision
pub const VERSION: &str = "3.4.2-fix-keyup";

/// Tag part of the revision
pub const REVISION_TAG: &str = "release-3.4.2-fix-keyup";
...
pub const REVISION_HASH: &str = "gf600c74c8";
